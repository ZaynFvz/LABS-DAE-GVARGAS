...
class App extends Component {
  constructor(props) {
    ...
    this.state = ({
      ...
      rating: '0',
      categoria: '',
      opcionesCategorias: ['drama', 'comedy', 'action', 'horror']
    })
        ...
        <Container>
          ...
          <Form onSubmit={this.guardar}>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control as="select" value={this.state.categoria} onChange={this.cambioCategoria}>
                {this.state.opcionesCategorias.map((opcion, index) => (
