...
# Mostrar las categorias de nuestra tienda
...
#Mostrar las categorias de nuestra tienda incluyendo metodos POST y GET para añadir nuevos elementos 
class CategoriaView(generics.ListCreateAPIView):
    queryset = Categoria.objects.all()
    serializer_class = CategoriaSerializer

#Métodos para eliminar y editar las categorias
